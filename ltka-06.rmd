$$$ cover-05-gen-fa %split 40 %pretitle Overview &amp; Examples %titleprop .fsize150[.or1[**Cloud** Computing]]  %authorprop [Dr.-Ing. Eueung Mulyana](https://github.com/eueung) %linkprop https://eueung.github.io/ET3010 % otherprop ET-3010 | [Attribution-ShareAlike CC BY-SA](https://creativecommons.org/licenses/by-sa/4.0/) %logo .fonth5[.fa-2x.fa-stack[<i class="fa fa-mixcloud fa-stack-2x fa-rotate-270"></i><i class="fa fa-code-fork fa-stack-2x fa-rotate-90"></i>]] %sname bkgtri-1
---
$$$ outline % fsize fonth4 %e1 |Introduction| %e2 |Computing at Scale| %e3 |Cloud Infrastructure| %e4 |Public Cloud Examples| 
---
$$$ cover-05-section-gen-fa %split 40 %titleprop .fsize85[Introduction] %logo .fonth5[.fa-2x.fa-stack[<i class="fa fa-mixcloud fa-stack-2x fa-rotate-270"></i><i class="fa fa-code-fork fa-stack-2x fa-rotate-90"></i>]] %sname bkgtri-2
---
...
$$$ part-3 
---
$$$ slide-one % col t1 %title #.fsize125[.yellow[**Trends**]]
---
...
---
$$$ slide-one % col t1 %title #.fsize125[.yellow[**Definitions**]]
---
class: bkgpos_00 nopadding
...
$$$ part-3 
---
$$$ slide-one % col t1 %title #.fsize125[.yellow[**Benefits**]]
---
$$$ part-1 %split 40 %color1 t1 %align1 right 
#.fsize150.or1[**Cloud**]
#.bluelight[Computing]
...
$$$ part-3 
---
$$$ slide-one % col t1 %title #.fsize125[.yellow[**Services**]]
### (**Delivery Models**)
---
$$$ part-1 %split 40 %color1 t1 %align1 right 
#.fsize150.or1[**Cloud**]
...
---
$$$ slide-one % col t1 %title #.fsize125[.yellow[**Deployments**]]
---
$$$ part-1 %split 40 %color1 t1 %align1 right 
#.fsize150.or1[**Cloud**]
#.bluelight[Computing]
...
---
$$$ slide-one % col t1 %title #.fsize125[.yellow[**Uses**]]
---
$$$ part-1 %split 40 %color1 t1 %align1 right 
#.fsize150.or1[**Cloud**]
#.bluelight[Computing]
...
$$$ part-3 
---
$$$ slide-one % col t1 %title #.fsize125[Common]
...
---
$$$ slide-one % col t1 %title #.fsize125[.yellow[**Check**] Point]
---
class: bkgpos_00 nopadding
...
---
$$$ cover-05-section-gen-fa %split 40 %titleprop .fsize85[Computing at Scale] %logo .fonth5[.fa-2x.fa-stack[<i class="fa fa-mixcloud fa-stack-2x fa-rotate-270"></i><i class="fa fa-code-fork fa-stack-2x fa-rotate-90"></i>]] %sname bkgtri-3
---
$$$ part-1 %split 40 %color1 t1 %align1 right 
...
$$$ part-3 
---
$$$ slide-one % col t1 %title #.fsize125[.yellow[**Needs**]]
---
$$$ part-1 %split 40 %color1 t1 %align1 right 
#.fsize75.or1[**Computing**]
#.bluelight[at Scale]
...
$$$ part-3 
---
$$$ slide-one % col t1 %title #.fsize125[(Hi)Story of .yellow[**Scaling**]]
...
---
$$$ slide-one % col t1 %title #.fsize125[.yellow[**Classical**] Scaling Approaches]
---
$$$ part-1 %split 40 %color1 t1 %align1 right 
#.fsize75.or1[**Computing**]
#.bluelight[at Scale]
...
$$$ part-3 
---
$$$ cover-05-section-gen-fa %split 40 %titleprop .fsize85[Cloud Infrastructure] %logo .fonth5[.fa-2x.fa-stack[<i class="fa fa-mixcloud fa-stack-2x fa-rotate-270"></i><i class="fa fa-code-fork fa-stack-2x fa-rotate-90"></i>]] %sname bkgtri-4
---
$$$ part-1 %split 40 %color1 t1 %align1 right 
#.fsize150.or1[**Cloud**]
...
Ref: [sdxcentral](https://www.sdxcentral.com/cloud/definitions/cloud-infrastructure-introduction/)
$$$ part-3 
---
class: bkgpos_00 nopadding
...
$$$ part-2 % color2 wt % align2 defaultalign 
#.fsize95[**Data-Center**]
.fonth4[
...
It automates, scales and manages cloud apps throughout their lifecycle. Applications can be written in just about .uline[any] language and are deployed in container images on .uline[any] infrastructure.
...
---
$$$ cover-05-section-gen-fa %split 40 %titleprop .fsize85[Public Cloud Examples] %logo .fonth5[.fa-2x.fa-stack[<i class="fa fa-mixcloud fa-stack-2x fa-rotate-270"></i><i class="fa fa-code-fork fa-stack-2x fa-rotate-90"></i>]] %sname bkgtri-5
---
$$$ part-1 %split 40 %color1 t1 %align1 right 
#.or1[**Public**]
#.fsize150.or1[**Cloud**]
...
$$$ part-3 
---
$$$ slide-one % col t1 %title #.fsize125.or1[**AWS**]
...
---
$$$ slide-one % col t1 %title #.fsize125.or1[**GCP**]
...
---
$$$ slide-one % col t1 %title #.fsize125[**Azure**]
---
$$$ part-1 %split 40 %color1 t1 %align1 right 
#.or1[**Public**]
#.fsize150.or1[**Cloud**]
