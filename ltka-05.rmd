$$$ cover-05-gen-fa %split 40 %pretitle System, Architecture &amp; Examples %titleprop .fsize125[.or1[Connected Things], .or1[IoT] &amp; .or1[5G]]  %authorprop [Dr.-Ing. Eueung Mulyana](https://github.com/eueung) %linkprop https://eueung.github.io/ET3010 % otherprop ET-3010 | [Attribution-ShareAlike CC BY-SA](https://creativecommons.org/licenses/by-sa/4.0/) %logo .fonth5[.fa-2x.fa-stack[<i class="fa fa-mixcloud fa-stack-2x fa-rotate-270"></i><i class="fa fa-code-fork fa-stack-2x fa-rotate-90"></i>]] %sname bkgtri-1
---
$$$ outline % fsize fonth4 %e1 |Connected Things &amp; IoT - Overview| %e2 |Model &amp; Architecture| %e3 |5G Infrastructure| %e4 |Applications &amp; Use-Cases| 
---
$$$ cover-05-section-gen-fa %split 40 %pretitle Overview %titleprop .fsize85[Connected Things &amp; IoT] %logo .fonth5[.fa-2x.fa-stack[<i class="fa fa-mixcloud fa-stack-2x fa-rotate-270"></i><i class="fa fa-code-fork fa-stack-2x fa-rotate-90"></i>]] %sname bkgtri-2
---
...
$$$ cover-05-section-gen-fa %split 40 %titleprop .fsize85[Model &amp; Architecture] %logo .fonth5[.fa-2x.fa-stack[<i class="fa fa-mixcloud fa-stack-2x fa-rotate-270"></i><i class="fa fa-code-fork fa-stack-2x fa-rotate-90"></i>]] %sname bkgtri-9
---
class: bkgpos_00 nopadding
...
$$$ cover-05-section-gen-fa %split 40 %pretitle Infrastructure %titleprop .fsize85[5G] %logo .fonth5[.fa-2x.fa-stack[<i class="fa fa-mixcloud fa-stack-2x fa-rotate-270"></i><i class="fa fa-code-fork fa-stack-2x fa-rotate-90"></i>]] %sname bkgtri-4
---
$$$ slide-one % col t1 %title #.fsize125[.yellow[**5G**] &amp; .yellow[**IoT**]]
...
$$$ cover-05-section-gen-fa %split 40 %titleprop .fsize85[Applications &amp; Use-Cases] %logo .fonth5[.fa-2x.fa-stack[<i class="fa fa-mixcloud fa-stack-2x fa-rotate-270"></i><i class="fa fa-code-fork fa-stack-2x fa-rotate-90"></i>]] %sname bkgtri-3
---
$$$ part-1 %split 40 %color1 t1 %align1 right 
###Apps &amp; Examples
