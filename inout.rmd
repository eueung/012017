$$$ cover-05-gen %split 40 %maxh 550 %opc 7 %pretitle Sensors &amp; Actuators % titleprop .fsize125[.yellow[Selected]] .fsize175[.yellow[**I/O**s]] % authorprop [Eueung Mulyana](https://github.com/eueung) % linkprop https://eueung.github.io/012017/inout % otherprop CodeLabs | [Attribution-ShareAlike CC BY-SA](https://creativecommons.org/licenses/by-sa/4.0/) %logopic images/logo-sensor.png % bkgimg bkgs/biru.jpg 
---
$$$ outline % fsize fonth4 %e1 |Preparation| %e2 |Light/Laser Sensor| %e3 |PIR Sensor| %e4 |LM35 &amp; DHT11| %e5 |.yellow[**Processing &amp; Local Visualization**]| %e6 |Ultrasonic Sensor| 
---
$$$ cover-05-section-gen %split 30 %maxh 550 %opc 7 % titleprop .fsize95[Preparation] % bkgimg bkgs/biru.jpg % logopic images/logo-sensor.png
---
$$$ slide-one % col t1 % title .fonth2[.yellow[**Preparation**] **Notes**]<br/><br/>.fonth5[We reuse the previous nRF24L01+ example (.bluelight[**Simple Remote Control**]) with some changes i.e.: for simplicity both nodes are now Nano-based, an LCD is attached to Node-2 for a better communication and debugging experience.]<br/><br/>.fonth4[In the next examples, the switch will be replaced with laser and PIR sensors.]
---
...
---
$$$ cover-05-section-gen %split 30 %maxh 550 %opc 7 % titleprop .fsize95[Light/Laser Sensor] % bkgimg bkgs/biru.jpg % logopic images/logo-sensor.png
---
class: bkgpos_00 nopadding
...
---
$$$ cover-05-section-gen %split 30 %maxh 550 %opc 7 % titleprop .fsize95[PIR Sensor] % bkgimg bkgs/biru.jpg % logopic images/logo-sensor.png
---
class: bkgpos_00 nopadding split-50
...
---
$$$ cover-05-section-gen %split 30 %maxh 550 %opc 7 % titleprop .fsize95[LM35 &amp; DHT11] % bkgimg bkgs/biru.jpg % logopic images/logo-sensor.png
---
class: bkgpos_00 nopadding
...
$$$ part-2 % color2 bt2 % align2 defaultalign 
##.fonth5[**LM35**]
.fonth5[
...
---
$$$ cover-05-section-gen %split 30 %maxh 550 %opc 7 %pretitle Local Visualization &amp; UI %titleprop .fsize95[Processing] % bkgimg bkgs/biru.jpg % logopic images/logo-sensor.png
---
class: bkgpos_00 nopadding split-50
...
---
$$$ cover-05-section-gen %split 30 %maxh 550 %opc 7 %pretitle HC-SR04 %titleprop .fsize95[Ultrasonic Sensor] % bkgimg bkgs/biru.jpg % logopic images/logo-sensor.png
---
class: bkgpos_00 nopadding split-50
background-image: url(images/inout11.jpg)
...
---
$$$ slide-one % col t1 % title #.fonth4[.yellow[**SR04**] **Sonar**]
...
background-image: url(images/inout29.jpg)
---
$$$ cover-05-section-gen %split 30 %maxh 550 %opc 7 % titleprop .fsize95[Refs/Resources] % bkgimg bkgs/biru.jpg % logopic images/logo-sensor.png
---
# Refs/Resources
...
---
$$$ cover-05-gen %split 40 %maxh 550 %opc 7 %titleprop .fsize175.yellow[END] % authorprop [Eueung Mulyana](https://github.com/eueung) % linkprop https://eueung.github.io/012017/inout % otherprop CodeLabs | [Attribution-ShareAlike CC BY-SA](https://creativecommons.org/licenses/by-sa/4.0/) % bkgimg bkgs/biru.jpg % logopic images/logo-sensor.png
