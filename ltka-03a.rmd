$$$ cover-05-gen-fa %split 40 %pretitle Connected Services %titleprop .fsize95[.yellow[Services Convergence] &amp; Digital Ecosystems] %authorprop [Dr.-Ing. Eueung Mulyana](https://github.com/eueung) %linkprop https://eueung.github.io/ET3010 % otherprop ET-3010 | [Attribution-ShareAlike CC BY-SA](https://creativecommons.org/licenses/by-sa/4.0/) %logo .fonth5[.fa-2x.fa-stack[<i class="fa fa-mixcloud fa-stack-2x fa-rotate-270"></i><i class="fa fa-code-fork fa-stack-2x fa-rotate-90"></i>]] %sname bkgtri-1
---
$$$ outline % fsize fonth4 %e1 |.yellow[Services Convergence]| %e2 |.yellow[Impacts of Services Convergence]| %e3 |Digital Ecosystem| %e4 |Examples of Digital Ecosystem| 
---
$$$ cover-05-section-gen-fa %split 40 %titleprop .fsize85[Services Convergence] %logo .fonth5[.fa-2x.fa-stack[<i class="fa fa-mixcloud fa-stack-2x fa-rotate-270"></i><i class="fa fa-code-fork fa-stack-2x fa-rotate-90"></i>]] %sname bkgtri-2
---
...
$$$ part-2 % color2 t1 % align2 defaultalign %title2 # .fonth5[Two Separate **Islands**]
.fonth5[
...
$$$ part-2 % color2 t1 % align2 defaultalign %title2 # .fonth5[One Big **Island**]
.fonth5[
...
$$$ part-3 
---
$$$ cover-05-section-gen-fa %split 40 %titleprop .fsize85[Impacts of Services Convergence] %logo .fonth5[.fa-2x.fa-stack[<i class="fa fa-mixcloud fa-stack-2x fa-rotate-270"></i><i class="fa fa-code-fork fa-stack-2x fa-rotate-90"></i>]] %sname bkgtri-3
---
$$$ part-1 %split 60 %color1 t2 %align1 center 
.figplaint[
