$$$ cover-05-gen-fa %split 40 %pretitle Connected Services %titleprop .fsize95[Services Convergence &amp; .yellow[Digital Ecosystems]] %authorprop [Dr.-Ing. Eueung Mulyana](https://github.com/eueung) %linkprop https://eueung.github.io/ET3010 % otherprop ET-3010 | [Attribution-ShareAlike CC BY-SA](https://creativecommons.org/licenses/by-sa/4.0/) %logo .fonth5[.fa-2x.fa-stack[<i class="fa fa-mixcloud fa-stack-2x fa-rotate-270"></i><i class="fa fa-code-fork fa-stack-2x fa-rotate-90"></i>]] %sname bkgtri-1
---
$$$ outline % fsize fonth4 %e1 |Services Convergence| %e2 |Impacts of Services Convergence| %e3 |.yellow[Digital Ecosystem]| %e4 |.yellow[Examples of Digital Ecosystem]|  
---
$$$ cover-05-section-gen-fa %split 40 %titleprop .fsize85[Digital Ecosystem] %logo .fonth5[.fa-2x.fa-stack[<i class="fa fa-mixcloud fa-stack-2x fa-rotate-270"></i><i class="fa fa-code-fork fa-stack-2x fa-rotate-90"></i>]] %sname bkgtri-2
---
...
$$$ part-2 % color2 t1 % align2 defaultalign %title2 # .fonth5[Simple CS Model]
.fonth5[
User - Device - System
]
$$$ part-3 
...
.fonth5[]
$$$ part-2 % color2 t1 % align2 defaultalign %title2 # .fonth5[Abstract Device Model]
.fonth5[
]
$$$ part-3 
---
...
$$$ part-2 % color2 t1 % align2 defaultalign %title2 # .fonth5[Device]
.fonth4.bluelight[
**Hardware**
]
$$$ part-3 
...
$$$ part-2 % color2 t1 % align2 defaultalign %title2 # .fonth5[CS Model]
.fonth4.bluelight[
]
.fonth5.yellow[
**User**<br/>
...
.fonth5[]
$$$ part-2 % color2 t1 % align2 defaultalign %title2 # .fonth5[Mobile is Huge!]
.fonth4.bluelight[
]
.fonth5[
...
---
$$$ cover-05-section-gen-fa %split 40 %titleprop .fsize85[Examples of Digital Ecosystem] %logo .fonth5[.fa-2x.fa-stack[<i class="fa fa-mixcloud fa-stack-2x fa-rotate-270"></i><i class="fa fa-code-fork fa-stack-2x fa-rotate-90"></i>]] %sname bkgtri-3
---
class: bkgpos_00 nopadding
...
---
$$$ part-1 %split 30 %color1 t1 %align1 right 
#.fonth5[Apple]
